...
if (!function_exists('axil_custom_customize_register')) {
    function axil_custom_customize_register()
    {
         ...
         * Custom Separator
         */
        class Blogar_Separator_Custom_control extends WP_Customize_Control
        {
...
class axil_Customize
{
    ...
    public static function register($wp_customize)
    {
        ...
        $wp_customize->add_panel('axil_colors_options',
            array(
                'title' => esc_html__('Blogar Colors Options', 'blogar'), //Visible title of section
                'priority' => 35, //Determines what order this appears in
                'capability' => 'edit_theme_options', //Capability needed to tweak
                'description' => esc_html__('Allows you to customize some example settings for axil.', 'blogar'), //Descriptive tooltip
            )
        );

        $wp_customize->add_section('axil_colors_main_options',
            array(
                'title' => esc_html__('General', 'blogar'), //Visible title of section
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            'axil_color_primary',
            array(
                'label' => esc_html__('Primary Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Secondary Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Secondary Alt Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            'axil_color_tertiary',
            array(
                'label' => esc_html__('Tertiary Color', 'blogar'),
        ...
        $wp_customize->add_control(new Blogar_Separator_Custom_control($wp_customize, 'axil_separator_heading_hover', array(
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            'axil_color_heading',
            array(
                'label' => esc_html__('Heading Color', 'blogar'),
        ...
        $wp_customize->add_control(new Blogar_Separator_Custom_control($wp_customize, 'axil_separator_body_color', array(
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            'axil_color_body',
            array(
                'label' => esc_html__('Body Color', 'blogar'),
                'settings' => 'color_body',
                'priority' => 10,
                'section' => 'axil_colors_main_options',
            )
        ...
        $wp_customize->add_control(new Blogar_Separator_Custom_control($wp_customize, 'axil_separator_meta_color2', array(
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            'axil_color_meta',
            array(
                'label' => esc_html__('Meta Text Color', 'blogar'),
                'settings' => 'color_meta',
                'priority' => 10,
                'section' => 'axil_colors_main_options',
            )
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Meta Link Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Meta Link Hover Color', 'blogar'),
        ...
        $wp_customize->add_section('axil_colors_header_options',
            array(
                'title' => esc_html__('Header', 'blogar'), //Visible title of section
                'priority' => 10, //Determines what order this appears in
                'capability' => 'edit_theme_options', //Capability needed to tweak
                'panel' => 'axil_colors_options',
            )
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Navigation Link Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Navigation Link Hover + Active Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Navigation Background Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Navigation Border Color', 'blogar'),
        ...
        $wp_customize->add_control(new Blogar_Separator_Custom_control($wp_customize, 'axil_separator_header_top_separetor', array(
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Header Top: Link Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Header Top: Link Hover + Active Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Header Top: Background Color', 'blogar'),
        ...
        $wp_customize->add_section('axil_colors_footer_options',
            array(
                'title' => esc_html__('Footer', 'blogar'), //Visible title of section
                'priority' => 35, //Determines what order this appears in
                'capability' => 'edit_theme_options', //Capability needed to tweak
                'panel' => 'axil_colors_options',
            )
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Title Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Link Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Link Hover Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Footer Bottom Border Color', 'blogar'),
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control(
            ...
            array(
                'label' => esc_html__('Footer Background Color', 'blogar'),
