...
<header class="header axil-header header-style-3  header-light <?php echo esc_attr($header_sticky) ?>  <?php echo esc_attr($header_transparent) ?> ">
    ...
    <?php $has_search_form = (!empty($axil_options['axil_enable_header_search']) && $axil_options['axil_enable_header_search']) ? "9" : "12"; ?>
    <div class="header-bottom">
        <div class="container">
            <div class="row justify-content-center justify-content-xl-between align-items-center">
                <div class="col-md-6 col-sm-3 col-4 col-xl-<?php echo esc_attr($has_search_form); ?>">
                ...
                <?php if(!empty($axil_options['axil_enable_header_search']) && $axil_options['axil_enable_header_search']){ ?>
                    <div class="col-xl-3 col-md-6 col-sm-9 col-8">
