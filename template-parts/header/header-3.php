...
<header class="header axil-header header-style-6 header-light <?php echo esc_attr($header_sticky) ?>  <?php echo esc_attr($header_transparent) ?> ">
    ...
    <?php $has_search_form = (!empty($axil_options['axil_enable_header_search']) && $axil_options['axil_enable_header_search']) ? "10" : "12"; ?>
    <div class="header-bottom">
        <div class="row justify-content-between align-items-center">
            <div class="col-xl-<?php echo esc_attr($has_search_form); ?> col-md-6 col-sm-3 col-4">
            ...
            <?php if(!empty($axil_options['axil_enable_header_search']) && $axil_options['axil_enable_header_search']){ ?>
                <div class="d-none d-sm-block col-xl-2 col-md-6 col-sm-9 col-8">
            ...
            <div class="col-xl-5 col-12 d-block d-xl-none">
