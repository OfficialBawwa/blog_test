...
?>
<!-- Start Header -->
<header class="header axil-header header-style-1 header-dark header-with-shadow <?php echo esc_attr($header_sticky) ?>  <?php echo esc_attr($header_transparent) ?>">
    <div class="header-wrap">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="axil-mainmenu-withbar col-md-3 col-sm-3 col-3 col-lg-<?php echo esc_attr($has_search_form); ?>">
