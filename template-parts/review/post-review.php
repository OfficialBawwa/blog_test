                    ...
                    if($pors){ ?>
                        <div class="col-xs-12 col-sm-6">
                            <div class="axil-post-review__pros">
                                <h5 class="axil-post-review__list-title"><?php echo (!empty($blogar_options['axil_post_review_pors_label'])) ? $blogar_options['axil_post_review_pors_label'] : "Pors"; ?></h5>
                                <ul>
                    ...
                    if($cons){ ?>
                        <div class="col-xs-12 col-sm-6">
                            <div class="axil-post-review__cons">
                                <h5 class="axil-post-review__list-title"><?php echo (!empty($blogar_options['axil_post_review_cons_label'])) ? $blogar_options['axil_post_review_cons_label'] : "Cons"; ?></h5>
                                <ul>
